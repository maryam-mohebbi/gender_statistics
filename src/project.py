...
app.layout = html.Div(
    children=[
        html.H1('Birth Vs Death Rate per 1000 people'), # birth vs death
        dcc.Graph(
        ...
        html.Br(),
        html.H1('Mortality Rates'),
        html.Div(mor_plots), # mortality plots
        html.Br(),
        html.H1('Infants Death'), # infants death plots
        html.Div(in_plots),
        html.H1('Immunization'), # immunization heat maps
        dcc.Graph(
        ...
        html.Br(),
        html.H1('Survival to age 65, (% of cohort)'), # survival sactter plot
        dcc.Graph(
            id='animated-bubble-plot',
